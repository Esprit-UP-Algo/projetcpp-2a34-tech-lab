...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->distanceMeasured((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->erreurConnexion((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->etatConnecte((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        ...
        }
        {
            ...
            if (_t _q_method = &Arduino::distanceMeasured; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        ...
        }
        {
            ...
            if (_t _q_method = &Arduino::etatConnecte; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 1
void Arduino::distanceMeasured(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void Arduino::etatConnecte(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
